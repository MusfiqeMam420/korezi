...
export default function ProductCard({ product }: { product: Product }) {
  ...
  const img: string | undefined = imgPath
    ...
    addToCart(
      {
        ...
        image: img, // ✅ string | undefined (NOT null)
      },
      1
    );
  }
      ...
      <div className="aspect-square bg-gray-50 overflow-hidden">
        {img && !imageFailed ? (
          <img
            src={img}
            alt={product.name}
            className="w-full h-full object-contain p-2 group-hover:scale-[1.03] transition"
            loading="lazy"
      ...
      <div className="p-4">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <h3 className="text-sm lg:text-lg mt-3 font-medium text-gray-900 line-clamp-3">
              {product.name}
            </h3>
          </div>
