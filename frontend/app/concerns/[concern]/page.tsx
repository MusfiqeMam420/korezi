...
export default function ConcernPage() {
  ...
  const concernParam = params?.concern || "";

  const concernValue = useMemo(() => {
    const decoded = decodeURIComponent(concernParam);
  ...
  const title = titleCase(concernValue);
    ...
    <div className="max-w-6xl mx-auto px-6 py-10">
      ...
      <div className="mt-8">
        {loading ? (
          ...
          <p className="text-gray-500">No products found for this concern.</p>
        ) : (
